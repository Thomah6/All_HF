...
<a class="text-sm text-gray-500 mt-3 text-right hover:text-primary transition-colors duration-300" href="#">Mot de passe oublié ?</a>
</div>
<button class="flex items-center justify-center text-center font-bold text-base leading-normal text-white bg-gray-700 rounded-full h-14 w-full mt-4 shadow-glow-cyan-magenta hover:shadow-glow-cyan-magenta-lg transition-shadow duration-300" type="submit">Se connecter</button>
</form>
</div>
</div>
</div>
